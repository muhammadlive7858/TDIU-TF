                                ...
                                <tbody>
                                    @isset($groupEdit)
                                        <form action="{{ route('group.update', $groupEdit->id) }}" method="post">
                                            ...
                                            <tr>
                                                <td>#</td>
                                                <td><input placeholder="Group full name" value="{{ $groupEdit->name }}"
                                                        type="text" name="name" class="form-control m-0"
                                                        required="required"></td>
                                                <td><input placeholder="Group's mentor" value="{{ $groupEdit->mentor_id }}"
                                                        type="number" name="mentor_id" class="form-control m-0"
                                                        required="required"></td>
                                                <td><input placeholder="Group's course" value="{{ $groupEdit->course_id }}"
                                                        type="number" name="course_id" class="form-control m-0"
                                                        required="required"></td>
                                                <td><input placeholder="Desription" value="{{ $groupEdit->active }}"
                                    ...
                                    @forelse($groups as $group)
                                        <tr>
                                            ...
                                            <td class="d-flex  justify-content-around">
                                                <a href="{{ route('group.edit', $group->id) }}" class=""><i
                                                        class="bi bi-pencil btn btn-success  "
                                                        style='border-radius:5px'>Edit</i></a>
                                                <a href="{{ route('group.show', $group->id) }}" class=""><i
